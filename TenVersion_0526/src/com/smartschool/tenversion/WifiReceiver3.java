...
//
//public class WifiReceiver3 extends BroadcastReceiver{
//	//wifi Key
...
//		  boolean vibrateState = WifiReceiver3.getCheckBoxPrefence(mContext,KEY_VIBRATE);
//		  if(vibrateState){
...
//		boolean alramState = WifiReceiver3.getCheckBoxPrefence(context, KEY_ALARM);
//		if (alramState) {
//
//			try {
